"""
HKTVmall Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from HKTVmall.

Docs  : https://docs.brightdata.de/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.de/products/insights/price-tracker/hktvmall
"""
...
# Set your Web Scraper ID after building your HKTVmall scraper:
# https://brightdata.de/products/web-scraper/hktvmall
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your HKTVmall scraper at: https://brightdata.de/products/web-scraper/hktvmall\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of HKTVmall product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover HKTVmall products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a HKTVmall category page.

    Example:
        results = discover_by_category("https://hktvmall.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.hktvmall.com/product/sample-item-123456",
        # Add more HKTVmall product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "hktvmall_prices.json"
    ...
    # cat_results = discover_by_category("https://hktvmall.com/category/sample", limit=50)
